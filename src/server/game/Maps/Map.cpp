...
void Map::AreaTriggerRelocation(AreaTrigger* at, float x, float y, float z, float orientation)
{
    ...
    {
#ifdef ACORE_DEBUG
        LOG_DEBUG("maps", "AreaTrigger ({}) added to moving list from grid[{}, {}] cell[{}, {}] to grid[{}, {}] cell[{}, {}].", at->GetGUID().ToString().c_str(), old_cell.GridX(), old_cell.GridY(), old_cell.CellX(), old_cell.CellY(), new_cell.GridX(), new_cell.GridY(), new_cell.CellX(), new_cell.CellY());
#endif
